# Trabalho da disciplina Desenvolvimento Web 3
...
Crie o banco de dados "trab_crud" com o comando a seguir:

```code
CREATE DATABASE trab_crud;
```

Entre no banco de dados "trab_crud" recém-criado com o comando:

```code
\c trab_crud
```

Agora, crie a tabela "salasdeaula" e insira os dados:
